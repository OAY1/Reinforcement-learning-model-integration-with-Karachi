...
class DQNAgent:
    ...
    def _build_model(self):
        ...
        #position vector
        input_1 = Input(shape=(12, 12, 1))  #12x12 position 1
        x1 = Conv2D(16, (4, 4), strides=(2, 2), activation='relu')(input_1) #apply filter 16 of 2D 4x4 size #pass through relu(ramp) function - continuos func
        x1 = Conv2D(32, (2, 2), strides=(1, 1), activation='relu')(x1)  #apply filter 32 of 2D 2x2 size #pass through relu(ramp) function - continuos func
        x1 = Flatten()(x1) #convert all data into a list

        #velocity vector
        input_2 = Input(shape=(12, 12, 1))  #12x12 position 1
        x2 = Conv2D(16, (4, 4), strides=(2, 2), activation='relu')(input_2) #apply filter 16 of 2D 4x4 size #pass through relu(ramp) function - continuos func
        x2 = Conv2D(32, (2, 2), strides=(1, 1), activation='relu')(x2)  #apply filter 32 of 2D 2x2 size #pass through relu(ramp) function - continuos func
        x2 = Flatten()(x2)  #convert all data into a list

        #state of signal vector
        input_3 = Input(shape=(2, 1))
        x3 = Flatten()(input_3) #convert all data into a list


        x = keras.layers.concatenate([x1, x2, x3])  #concatenate flatten data
...
if __name__ == '__main__':
    ...
    #sumoInt.generate_routefile()########################generate route file
